function	[dip,xl,xu, ifault, gcm, lcm, mn, mj] = HartigansDipTest_BDC(xpdf)
...
%
% BDC grabbed this code off-line on Nov 3 2019 to try to apply it to SRT
% data in Surya Dash ES paper. NOTE THAT WE MAKE NO ASSUMPTIONS ABOUT HOW
% CORRECT THIS CODE IS SO CONSIDER THIS A BETA TEST FOR NOW!

%% BRIAN'S ADDITIONS START HERE
if nargin == 0
    cd ('/data/monk')
    load('RTexample')
end

xpdf = xpdf(xpdf >= 50);    % removes SRTs lower than 50
