function plot_patchplot(xdata,ydata,plotcolor,plot_name, facealpha)
...
h = patch([xdata fliparray(xdata)],[(nanmean(ydata) + stderr_bc(ydata)) fliparray(nanmean(ydata) - stderr_bc(ydata))],'k', 'FaceAlpha', facealpha, 'LineStyle',"none");
