function [qMetric, unitType] = runAllQualityMetrics(param, spikeTimes_samples, spikeTemplates, ...
...
for iUnit = 1:size(uniqueTemplates, 1)
    ...
    [qMetric.nPeaks(iUnit), qMetric.nTroughs(iUnit), qMetric.mainPeak_before_size(iUnit), ...
        ...
        qMetric.mainPeak_after_width(iUnit), qMetric.mainTrough_width(iUnit), forGUI.peakLocs{iUnit}, ...
